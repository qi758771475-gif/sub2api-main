  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        purchaseSubscriptionEnabled: '外部充值',
        purchaseSubscriptionEnabledHint: '在侧边栏显示"充值"菜单，点击后以 iframe 方式打开外部充值页面',
        purchaseSubscriptionUrl: '外部充值链接',
        purchaseSubscriptionUrlHint: '用户点击"充值"后打开的外部页面地址',
