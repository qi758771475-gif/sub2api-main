export default {
  ...
  admin: {
    ...
    settings: {
      ...
      notification: {
        ...
        enabledHint: 'When enabled, recharge and redeem notifications will be pushed to Feishu group via webhook',
      ...
      payment: {
        ...
        purchaseSubscriptionEnabled: 'External Recharge',
        purchaseSubscriptionEnabledHint: 'Show "Recharge" menu in sidebar, opens external recharge page in iframe',
        purchaseSubscriptionUrl: 'External Recharge URL',
        purchaseSubscriptionUrlHint: 'The external page URL opened when user clicks "Recharge"',
  ...
  // Purchase Subscription Shop (iframe embed)
  purchaseShop: {
    notConfigured: 'Recharge URL not configured',
  },
